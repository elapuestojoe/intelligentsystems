...
class PicAPix(CSP):
    ...
    def nconflicts(self, var, val, assignment):
        ...
        # Constraint 2
            ...
            v = countOcurrences(fourthColumn, "R")
            conflicts += abs(2 - v)

            # if(v == 2 and get_v_neighbors(fourthColumn, "R")):
            #     conflicts+=1
        ...
        if var in row1:
            ...
            v = countOcurrences(secondRow, "R")
            conflicts += abs(2 - v)

            if(v == 2 and get_h_neighbors(secondRow, "R")):
                conflicts +=1         
            ...
            v = countOcurrences(fourthRow, "V")
            conflicts += abs(2 - v)

            if(v == 2 and get_h_neighbors(fourthRow, "V")):
                conflicts +=1
            ...
            v = countOcurrences(fifthRow, "V")
            conflicts += abs(2 - v)

            if(v == 2 and not get_h_neighbors(fifthRow, "V")):
                conflicts+= 1
