...
class PicAPix(CSP):
	...
	def update_domains(self):
		...
		# HARDCODED DOMAIN SPECIFIC COSAS
		self.domains[13] = ["."]
		# self.domains[1].remove("R")
		# self.domains[1].remove("G")
	def assign(self, var, val, assignment):
...
# s.domains[16].append("G")
# s.domains[18].append("G")
...
# print("SOLUTION",min_conflicts(s))
# print("CURR",s.current)
# print(s.domains)

# s.assign(0,".",s.current)
# s.assign(5,".",s.current)
# print("D", s.domains)
# print("CURR",s.current)
# print(backtracking_search(s))

# print(min_conflicts(s))
...
def solve(pix):
	...
	while(steps > 0):
		if(isSolved(pix)):
			print("SOLVED in", 10000000-steps)
			print(pix.current)
			break
		else:
