...
class PicAPix(CSP):
    ...
    #     def conflict_h(var2):
    #         return (var2 in assignment and
    #                 not self.pic_a_pix_constraint_h(var, val, var2, assignment[var2]))
        
    #     def conflict_v(var2):
    #         return (var2 in assignment and
    #                 not self.pic_a_pix_constraint_v(var, val, var2, assignment[var2]))

    #     # print(self.countConf_V(assignment,var,val,self.neighbors_v[var]))
    #     return count(conflict_h(v) for v in self.neighbors_h[var]) + count(conflict_v(v) for v in self.neighbors_v[var])
    #     # c(assignment, var, val, self.neighbors_v[var])
    #     # return 0
